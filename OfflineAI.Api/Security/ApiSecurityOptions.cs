namespace OfflineAI.Api.Security;
...
public sealed class ApiSecurityOptions
{
    ...
    /// <summary>
    /// Exact origins allowed to make browser (CORS) requests, e.g.
    /// <c>["https://localhost:7015", "http://localhost:5118"]</c>. When empty, no cross-origin
    /// browser requests are permitted. Never reflect arbitrary origins together with credentials.
    /// </summary>
    ...
    /// This bounds how far an unauthenticated (or authenticated) caller can exhaust the LLM pool.
    /// </summary>
